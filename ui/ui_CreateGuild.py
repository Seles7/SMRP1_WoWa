...
"")
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(50, 80, 301, 93))
        self.formLayoutWidget.setObjectName("formLayoutWidget")
        self.formLayout = QtWidgets.QFormLayout(self.formLayoutWidget)
        self.formLayout.setContentsMargins(0, 0, 0, 0)
        self.formLayout.setObjectName("formLayout")
        self.Creator = QtWidgets.QLabel(self.formLayoutWidget)
        self.Creator.setEnabled(False)
        font = QtGui.QFont()
        font.setFamily("Monotype Corsiva")
        font.setPointSize(18)
        self.Creator.setFont(font)
        self.Creator.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:1, x2:0, y2:0.0340909, stop:0 rgba(61, 61, 61, 255), stop:1 rgba(124, 124, 124, 255));\n"
"color: rgb(255, 253, 189)")
        self.Creator.setObjectName("Creator")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.Creator)
        self.LineEdit_Creator = QtWidgets.QLineEdit(self.formLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(18)
        self.LineEdit_Creator.setFont(font)
        self.LineEdit_Creator.setObjectName("LineEdit_Creator")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.LineEdit_Creator)
...
"color: rgb(255, 253, 189)")
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.TitleGuild)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.LineEdit_TitleGuild)
    ...
    def retranslateUi(self, CreateGuildWidget):
        ...
        self.Creator.setText(_translate("CreateGuildWidget", "Основатель"))
